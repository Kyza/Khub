	...
	const config = {
	  ...
	  changelog: [
		...
		},
		{
		  ...
		  type: "improved",
		  items: [
			"The embed API is now back up permanently.",
			"The embed API has a custom domain now."
		  ]
		},
		{
		  title: "On-going",
	  ...
	  margin-bottom: 4px;
			...
			return class Emquoter extends Plugin {
			  ...
			  buildQuoteEmbed(messageLink, messageObject, inEmbed) {
				...
				// if (!messageLink.parentNode.parentNode.querySelector(`a[href*="http://em.kyza.gq/embed/"]`)) {
