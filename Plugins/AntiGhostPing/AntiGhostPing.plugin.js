              ...
              try {
                if (
                  ...
                  var daButtons = document.querySelector(
                    "div.container-3baos1 > div.flex-1xMQg5.flex-1O1GKY.horizontal-1ae9ci.horizontal-2EEEnY.flex-1O1GKY.directionRow-3v3tfG.justifyStart-2NDFzi.alignStretch-DpGPf3.noWrap-3jynv6"
                  );
                  ghostButton.setAttribute("type", "button");
                  ghostButton.setAttribute(
                    "class",
                    "button-14-BFJ enabled-2cQ-u7 button-38aScr lookBlank-3eh9lL colorBrand-3pXr91 grow-q77ONN ghostping-button-wrapper"
                  );

                  var ghostButtonInner = document.createElement("div");
                  ghostButtonInner.setAttribute(
                    "class",
                    "contents-18-Yxp button-3AYNKb button-2vd_v_ ghostping-button-inner"
                  );
                  ...
                  ghostButtonIcon.setAttribute(
                    "class",
                    "icon-3D60ES ghostping-button-icon"
                  );
