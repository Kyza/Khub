    ...
    : (([Plugin, Api]) => {
        const plugin = (Plugin, Api) => {
          ...
          return class GhostMessage extends Plugin {
                    ...
                    for (const attachment of event.message.attachments) {
                      let foundAttachment = files.find(file => {
                        return (
                          ...
                          DiscordAPI.User.fromId(
                            methodArguments[0].message.author.id
            ...
            addButton() {
              ...
              try {
                ...
                if (
                  ...
                  if (
                    document.getElementsByClassName("ghost-button-wrapper")
                      .length == 0
                  ) {
            ...
            removeButton() {
              if (
                document.getElementsByClassName("ghost-button-wrapper").length >
                0
              ) {
                document
                  .getElementsByClassName("ghost-button-wrapper")[0]
                  .remove();
                this.setEnabled(false);
              }
            }
            ...
            setEnabled(set) {
              ...
              if (ghostInner && ghostInner.children[0] && enabled) {
                ...
                ghostInner.children[0].setAttribute(
                  "style",
                  "transform: scale(1.2)"
                );
