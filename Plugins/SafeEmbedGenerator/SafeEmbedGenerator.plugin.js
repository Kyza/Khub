  ...
  cursor: pointer !important;
        ...
        observer({addedNodes}) {
          for (const node of addedNodes) {
            if (node.className == KSS.createClassName("|chat|") ||
        ...
        error(error, toast) {
          ...
          if (toast) {
            Toasts.show(before + error, {type : "error", timeout : 5000});
          ...
          try {
            ...
            if (this.hasPermission()) {
              ...
              if (!document.querySelector("#embed-button-wrapper") &&
                ...
                embedButtonIcon.setAttribute(
                    "class", KSS.createClassName("|pulseButton icon|"));
                ...
                embedButtonInner.onclick = () => { this.openPopup(); };
              }
            } else {
              this.removeButton();
            }
        ...
        isAllowed() {
          try {
            ...
            if (!guild) {
              return true;
            } else if ((guild.id != "86004744966914048" &&
        ...
        sendEmbed() {
          ...
          if (this.isAllowed()) {
            ...
            obj.providerUrl =
                providerURL.value; // The link on the Provider Name.
            obj.authorName = authorName.value;
            obj.authorUrl = authorURL.value; // The link on the Author Name.
            obj.title = title.value;
            obj.description = description.value;
            obj.banner = imageBanner.checked; // Photo is a banner, nothing is a
        ...
        enableButtons() {
          document.querySelector("#embed-send-button")
              .removeAttribute("disabled");
          document.querySelector("#embed-append-button")
              .removeAttribute("disabled");
          document.querySelector("#embed-cancel-button")
              .removeAttribute("disabled");
        }
        ...
        createPopup() {
          ...
          if (!document.querySelector("#embed-creator") &&
            ...
            providerName.className =
                KSS.createClassName("|inputDefault| |input|");
            ...
            color.value = "#1E2327";
            color.className =
                KSS.createClassName("|colorPickerSwatch| |custom| |noColor|");
            color.oninput = () => {
              this.validateInputs();
              this.updatePreview();
            };
            ...
            imageBanner.className =
                KSS.createClassName("|checkboxEnabled| |value checkbox|");
            ...
            embedGrid.className =
                KSS.createClassName("|spoilerAttachment grid|");
            ...
            embedTitle.className =
                KSS.createClassName("|embedTitle| |embedMargin|");
            ...
            embedDescription.className =
                KSS.createClassName("|embedDescription| |embedMargin|");
            ...
            sendButton.onclick = () => { this.sendEmbed(); };
            ...
            appendButton.onclick = () => { this.appendEmbed(); };
        ...
        openPopup() {
          ...
          document.querySelector("#embed-creator").className =
        ...
        validateInputs() {
          ...
          if (imageBanner.checked && authorName.value.length == 0 &&
              imageURL.value.length > 0) {
            enableSending = false;
            if (authorName.className.indexOf(
                    KSS.createClassName("|errorMessage error|")) < 0) {
              authorName.className +=
          ...
          if (providerName.value.length == 0 && authorName.value.length == 0 &&
        ...
        updatePreview() {
          ...
          let embedDescription =
              document.querySelector("#embed-preview-description");
          ...
          if (imageURL.value.length == 0 || !this.validURL(imageURL.value)) {
            ...
            if (imageBanner.checked) {
              ...
              embedImage.className =
                  KSS.createClassName("|imageWrapper| |embedThumbnail|");
            }
            ...
            var addImage = () => {
              ...
              var imageScale =
                  Math.min((imageBanner.checked ? 400 : 80) / imageWidth,
              ...
              embedImage.innerHTML =
                  `<img src="${imageURL.value}" style="width: ${
                      scaledImageWidth}px; height: ${scaledImageHeight}px;">`;
