...
var SafeEmbedGenerator = (() => {
  const config = {
    info: {
      ...
      github_raw:
        "https://raw.githubusercontent.com/KyzaGitHub/Khub/master/v1%20Plugins/SafeEmbedGenerator/SafeEmbedGenerator.plugin.js"
    },
    changelog: [
      {
        title: "New Stuff",
          ...
          return class SafeEmbedGenerator extends Plugin {
            ...
            openEmbedPopup() {
              if (!document.getElementById("embedPopupWrapper")) {
                ...
                var textInputStyle =
                  "background-color: #484B52; border: none; border-radius: 5px; height: 30px; padding-left: 10px;";
                ...
                imageType.setAttribute(
                  "class",
                  "flexChild-faoVW3 da-flexChild switchEnabled-V2WDBB switch-3wwwcV da-switchEnabled da-switch valueUnchecked-2lU_20 value-2hFrkk sizeDefault-2YlOZr size-3rFEHg themeDefault-24hCdX"
                );
                ...
                imageType.onclick = () => {
                  if (
                    ...
                    "flexChild-faoVW3 da-flexChild switchEnabled-V2WDBB switch-3wwwcV da-switchEnabled da-switch valueChecked-m-4IJZ value-2hFrkk sizeDefault-2YlOZr size-3rFEHg themeDefault-24hCdX"
                  ) {
                    imageType.setAttribute(
                      "class",
                      "flexChild-faoVW3 da-flexChild switchEnabled-V2WDBB switch-3wwwcV da-switchEnabled da-switch valueUnchecked-2lU_20 value-2hFrkk sizeDefault-2YlOZr size-3rFEHg themeDefault-24hCdX"
                ...
                imageTypeText.setAttribute(
                  "style",
                  "position: absolute; text-align: center; width: 100%; height: 100%; line-height: 22.5px;"
                );
                imageTypeInput.setAttribute(
                  "class",
                  "checkboxEnabled-CtinEn checkbox-2tyjJg da-checkboxEnabled da-checkbox"
                );
                ...
                fadeOutBackground.setAttribute(
                  "style",
                  "position: absolute; width: 100%; height: 100%; top: 22px; background-color: rgba(0, 0, 0, 0.8); z-index: 999999999999999999998;"
                );
